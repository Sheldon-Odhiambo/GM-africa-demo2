    ...
    <div className="fixed inset-0 z-[100] bg-secondary flex flex-col items-center justify-center">
      ...
      <div className="relative">
        ...
        <img
          ...
          alt="Company Logo"
          className="h-60 w-60 w-auto object-contain animate-spin-slow"
        />

        {/* Optional Center Glow */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-5 h-5 bg-primary rounded-full blur-[12px] animate-pulse flex items-center justify-center shadow-[0_0_60px_rgba(214,143,91,0.8)]">
            <i className="fa-solid fa-zebra text-secondary text-sm"></i>
          </div>
        </div>
      </div>
