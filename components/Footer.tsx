...
import { Logo, NAV_ITEMS, CONTACT_INFO } from '../constants';
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1 reveal">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white hover:bg-primary hover:text-secondary hover:-translate-y-1 transition-all" aria-label="Facebook">
                <i className="fa-brands fa-facebook-f"></i>
              </a>
              <a href="#" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white hover:bg-primary hover:text-secondary hover:-translate-y-1 transition-all" aria-label="Instagram">
                <i className="fa-brands fa-instagram"></i>
              </a>
              <a href={CONTACT_INFO.tiktok} className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white hover:bg-primary hover:text-secondary hover:-translate-y-1 transition-all" aria-label="TikTok">
          ...
          <div className="reveal" style={{ transitionDelay: '100ms' }}>
            ...
            <ul className="space-y-4">
              {NAV_ITEMS.map((item) => (
                <li key={item.href}>
                  <a href={item.href} className="text-white/50 text-xs font-bold uppercase tracking-widest hover:text-primary transition-all flex items-center gap-2 group">
          ...
          <div className="reveal" style={{ transitionDelay: '300ms' }}>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div className="text-white/50 text-xs font-bold tracking-tight">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-10">
            <a href="#" className="text-white/20 text-[9px] uppercase tracking-widest hover:text-primary transition-colors font-bold">Privacy</a>
            <a href="#" className="text-white/20 text-[9px] uppercase tracking-widest hover:text-primary transition-colors font-bold">Terms</a>
          </div>
        </div>
      </div>
    </footer>
